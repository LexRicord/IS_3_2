using crypt_lab_5.Interfaces;

namespace crypt_lab_5_EntropyChecker
{
    internal class EntropyChecker : IDocumentReader, IEntropyCheck, IPrintEntropy
    {
        ...
        {
            Dictionary<char, double> chances = new Dictionary<char, double>(this.alphabet.Count);
